...
def run(
        ...
        data=ROOT / 'data/xView.yaml',  # dataset.yaml path
        ...
        save_detected_frame = False, #save frame from video
        ...
        project=ROOT / 'outputs/lpd',  # save results to project/name
...
def parse_opt():
    ...
    parser.add_argument('--project', default=ROOT / 'outputs/lpd', help='save results to project/name')
